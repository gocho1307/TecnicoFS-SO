...
char *input_files[] = {
    "./tests/fs-tests/input1.txt", "./tests/fs-tests/input1.txt",
    "./tests/fs-tests/input2.txt", "./tests/fs-tests/input2.txt",
    "./tests/fs-tests/input3.txt", "./tests/fs-tests/input3.txt",
    "./tests/fs-tests/input4.txt", "./tests/fs-tests/input4.txt"};
...
void verify_append(char *source_file, char *tfs_file) {
    ...
    char buffer_external[BUFFER_LEN] = {0};
    char buffer_tfs[BUFFER_LEN] = {0};
    char buffer_control[BUFFER_LEN];
